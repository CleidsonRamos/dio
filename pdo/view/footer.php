<footer class="footer">
        <div class="container-fluid">
          <nav class="float-left">
            <ul>
              <li>
                <a href="https://www.facieg.com.br">
                  FACIEG
                </a>
              </li>
              <li>
                <a href="http://facieg.com.br/home/sobre">
                  Sobre nós
                </a>
              </li>
              <li>
                <a href="http://facieg.com.br/">
                  Blog
                </a>
              </li>
            </ul>
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="./material-dashboard-master/assets/img/sidebar-1.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="./material-dashboard-master/assets/img/sidebar-2.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="./material-dashboard-master/assets/img/sidebar-3.jpg" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="./material-dashboard-master/assets/img/sidebar-4.jpg" alt="">
          </a>
        </li>
  ...
  <script src="./material-dashboard-master/assets/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
